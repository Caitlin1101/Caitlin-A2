...
public class CameraController : MonoBehaviour
{
	...
	public void LateUpdate()
	{
		...
		smoothedPosition.x = Mathf.Clamp(desiredPosition.x, leftBoundary, rightBoundary);
		smoothedPosition.y = Mathf.Clamp(desiredPosition.y, bottomBoundary, desiredPosition.y);
